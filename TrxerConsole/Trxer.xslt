...
>
    ...
    <html>
      ...
      <body>
        <div id="divToRefresh" class="wrapOverall">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row" class="column1">Description</th>
                    ...
                    <xsl:for-each select="/t:TestRun/t:Results/t:TestResultAggregation/t:InnerResults/t:TestResultAggregation/t:InnerResults/t:UnitTestResult">
                      <xsl:if test ="@testName='TC_92354_Sanity_Test_01_Table_Title_Version'">
                        <td>
                          <!--<xsl:value-of select='/t:TestRun/t:Results/t:TestResultAggregation/t:InnerResults/t:UnitTestResult/t:Output/t:DebugTrace'/>-->
                          <xsl:value-of select="@testName/t:Output/t:DebugTrace"/>
                        </td>
                      </xsl:if>
                    </xsl:for-each>
          ...
          <xsl:variable name="testsFailedSet" select="//t:TestRun/t:Results/t:TestResultAggregation/t:InnerResults/t:UnitTestResult[@outcome='Failed']" />
          ...
          <Table>
            ...
            <tbody>
              <xsl:for-each select="/t:TestRun/t:Results/t:TestResultAggregation/t:InnerResults/t:UnitTestResult">
  ...
  <xsl:template name="tStatus">
    ...
    <xsl:for-each select="/t:TestRun/t:Results/t:TestResultAggregation/t:InnerResults/t:UnitTestResult[@testId=$testId]">
      <xsl:choose>
        ...
        <td colspan="6">
          ...
          <table>
            ...
            <tbody>
              <tr class="visibleRow">
                <td class="ex">
                  <xsl:value-of select="/t:TestRun/t:Results/t:TestResultAggregation/t:InnerResults/t:UnitTestResult[@testId=$testId]/t:Output/t:ErrorInfo/t:StackTrace" />
                </td>
              </tr>
            </tbody>
          </table>
  ...
  <xsl:template name="imageExtractor">
    <xsl:param name="testId" />
    <xsl:for-each select="/t:TestRun/t:Results/t:TestResultAggregation/t:InnerResults/t:UnitTestResult[@testId=$testId]/t:Output">
