...
{
    public class LayerPrecisionConfiguration : IControllerConfiguration
    {
...
#region RadiantHeatersHistory
        ...
        private Dictionary<Type, ControllerPageSetup> _fixedPagesSetupDictionary = new Dictionary<Type, ControllerPageSetup>()
        {
            ...
            #region Page Name: Temperature Curve
		   {
            ...
            //            {
            //                new TextColumn(){ DisplayName = "Curtain", IsReadOnly = true},
            //                new TextColumn(){ DisplayName = "Pot.", IsReadOnly = true },
            //                new TextColumn(){ DisplayName = "Potentiometer", InputMethod = new BaseNumericKeyPad(), IsReadOnly = false },
            //                new TextColumn(){ DisplayName = "Open", InputMethod = new BaseNumericKeyPad(), IsReadOnly = false },
            //                new TextColumn(){ DisplayName = "Close", InputMethod = new BaseNumericKeyPad(), IsReadOnly = false },
            //                new TextColumn(){ DisplayName = "Wind Direction", InputMethod = new BaseNumericKeyPad(), IsReadOnly = false },
            //            },
            //        SettingsPageTitles = new List<string>(){ "Vent/Curt Calibration" }
            //    }
            //},
            ...
            #region PAGE name: Zone Inlet Position
            {
                typeof(ZoneInletPositionPage), new ControllerPageSetup()
                {
                    PageTitles = new List<string>() { "Zone Inlet Position" },
                }
            }, 
            #endregion
        ...
        public LayerPrecisionConfiguration()
        {
            Name = "BroilerPrecision";
            WaterDevices = 4;
            FeedDevices = 4;
            AugerDevices = 4;
            LightDevices = 1;
            ...
            {
                ControllerType = ControllerType.PLATINUM_PLUS_LAYERS_PRECISION,
                MemoryVersion = 8,
                ControllerMajorVersion = 5,
                LevelControl = LevelControl.CM_SoftMin,

                /* Online path:*/
                MetadataDirectoryInfo = new DirectoryInfo(Path.GetFullPath("../../../Rotem.Touch.UITests.Infrastructure/ExternalDependencies//PLATINUM_PLUS_LAYERS_PRECISION_METADATA/"))
