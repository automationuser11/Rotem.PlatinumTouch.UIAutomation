...
{
    public class BreederPrecisionAdvancedFeedingConfiguration : IControllerConfiguration
    {
...
#region RadiantHeatersHistory
        ...
        public BreederPrecisionAdvancedFeedingConfiguration()
        {
            Name = "BreederPrecisionAdvancedFeeding";
            WaterDevices = 4;
            FeedDevices = 4;
            AugerDevices = 4;
            LightDevices = 1;
