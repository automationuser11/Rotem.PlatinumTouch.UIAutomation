...
{
    public class BroilerPrecisionConfiguration : IControllerConfiguration
    {
...
#region RadiantHeatersHistory
        ...
        public BroilerPrecisionConfiguration()
        {
            ...
            {
                ControllerType = ControllerType.PLATINUM_PLUS_BROILER_PRECISION,
                MemoryVersion = 8,
                ControllerMajorVersion = 5,
                LevelControl = LevelControl.CM_SoftMin,

                /* Online path:*/
                MetadataDirectoryInfo = new DirectoryInfo(Path.GetFullPath("../../../Rotem.Touch.UITests.Infrastructure/ExternalDependencies//PLATINUM_PLUS_BROILER_PRECISION_METADATA/"))
