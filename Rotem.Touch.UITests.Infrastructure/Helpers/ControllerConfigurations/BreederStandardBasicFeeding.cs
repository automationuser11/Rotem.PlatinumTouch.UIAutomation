...
{
    public class BreederStandardBasicFeedingConfiguration : IControllerConfiguration
    {
        private Dictionary<Type, ControllerPageSetup> _fixedPagesSetupDictionary = new Dictionary<Type, ControllerPageSetup>()
        {
        #region Breeder Standard BasicFeeding pages
                ...
                typeof(FoggersPage), new ControllerPageSetup()
{
    PageTitles = new List<string>() { "Foggers" },
        ...
        public BreederStandardBasicFeedingConfiguration()
        {
            Name = "BreederStandardBasicFeeding";
            WaterDevices = 4;
            FeedDevices = 4;
            AugerDevices = 4;
            LightDevices = 1;
