...
namespace Rotem.Touch.UITests.Infrastructure.Helpers.Extensions.Selenium
{
    ...
    internal static class ByFactory
    {
        ...
        /// </summary>
        /// <param name="attribute">The <see cref="MandatoryComponentAttribute"/> describing how to find the element.</param>
        /// <returns>An instance of the <see cref="By"/> class.</returns>
        public static By From(MandatoryComponentAttribute attribute)
        {
